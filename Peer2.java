...
public class Peer2 {
	...
	private static String localAddress = "/Users/Yunze/Documents/workspace/P2P/peer2/";
	...
	void run()
	{
		try{
			...
			//bind this socket with port number 8002
	...
	private static class listeningUploadThread extends Thread{	
		...
		public void run(){
			try{
				...
				//Wait for connection
				System.out.println("peer 2 Waiting for connection");
