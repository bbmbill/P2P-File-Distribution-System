...
public class Peer4 {
	...
	private static int localPort = 8004;
	private static int listeningPort = 7004;
	private static int downloadListeningPort = 7003;
	...
	private static String localAddress = "/Users/Yunze/Documents/workspace/P2P/peer4/";
	...
	void run()
	{
		try{
			...
			//bind this socket with port number 8004
	...
	private static void readConfiguration() throws Exception{
		    ...
		    while((readLine = reader.readLine()) != null){
				String[] tmp = readLine.split("  ");;
					...
					else if(tmp[0].equalsIgnoreCase("4")){
	...
	private static class listeningUploadThread extends Thread{
		...
		public void run(){
			try{
				...
				//Wait for connection
				System.out.println("peer 4 Waiting for connection");
