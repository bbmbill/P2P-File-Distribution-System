...
public class Peer1 {
	...
	private static int fileOwnerPort;
	private static int localPort;
	private static int listeningPort;
	private static int downloadListeningPort;
	...
	private static String localAddress = "/Users/Yunze/Documents/workspace/P2P/peer1/";
	...
	void run()
	{
		try{
			...
			//bind this socket with port number 8001
	...
	private static class listeningUploadThread extends Thread{
		...
		public void run(){
			try{
				...
				//Wait for connection
				System.out.println("peer 1 Waiting for connection");
...
//			} 
		...
		public void run(){
			try{
				...
				int request = 1;
				System.out.println("Send my request to download neighbor.");
