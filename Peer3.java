...
public class Peer3 {
	...
	private static String localAddress = "/Users/Yunze/Documents/workspace/P2P/peer3/";
	...
	void run()
	{
		try{
			...
			//bind this socket with port number 8003
	...
	private static void readConfiguration() throws Exception{
		    ...
		    while((readLine = reader.readLine()) != null){
				String[] tmp = readLine.split("  ");;
					...
					else if(tmp[0].equalsIgnoreCase("3")){
	...
	private static class listeningUploadThread extends Thread{
		...
		public void run(){
			try{
				...
				//Wait for connection
				System.out.println("peer 3 Waiting for connection");
